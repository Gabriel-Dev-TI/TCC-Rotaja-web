...
Route::middleware(['cargo:admin'])->group(function () {
    ...
    Route::get('/admin/entregadores', [AdminController::class, 'entregadores'])
        ->name('admin.entregadores.index');

    Route::get('/admin/entregadores/criar', [AdminController::class, 'createEntregador'])
        ->name('admin.entregadores.create');

    Route::post('/admin/entregadores', [AdminController::class, 'storeEntregador'])
        ->name('admin.entregadores.store');

    Route::get('/admin/entregadores/{entregador}/editar', [AdminController::class, 'editEntregador'])
        ->name('admin.entregadores.edit');

    Route::patch('/admin/entregadores/{entregador}', [AdminController::class, 'updateEntregador'])
        ->name('admin.entregadores.update');

    Route::delete('/admin/entregadores/{entregador}', [AdminController::class, 'destroyEntregador'])
        ->name('admin.entregadores.destroy');
    ...
    Route::get('/admin/empresas/criar', [AdminController::class, 'createEmpresa'])
        ->name('admin.empresas.create');

    Route::post('/admin/empresas', [AdminController::class, 'storeEmpresa'])
        ->name('admin.empresas.store');

    Route::get('/admin/empresas/{empresa}/editar', [AdminController::class, 'editEmpresa'])
        ->name('admin.empresas.edit');

    Route::patch('/admin/empresas/{empresa}', [AdminController::class, 'updateEmpresa'])
        ->name('admin.empresas.update');

    Route::delete('/admin/empresas/{empresa}', [AdminController::class, 'destroyEmpresa'])
    ...
    Route::get('/admin/entregas', [AdminController::class, 'entregas'])
        ->name('admin.entregas.index');

    Route::get('/admin/entregas/criar', [AdminController::class, 'createEntrega'])
        ->name('admin.entregas.create');

    Route::post('/admin/entregas', [AdminController::class, 'storeEntrega'])
        ->name('admin.entregas.store');

    Route::get('/admin/entregas/{entrega}/editar', [AdminController::class, 'editEntrega'])
        ->name('admin.entregas.edit');

    Route::patch('/admin/entregas/{entrega}', [AdminController::class, 'updateEntrega'])
        ->name('admin.entregas.update');

    Route::delete('/admin/entregas/{entrega}', [AdminController::class, 'destroyEntrega'])
        ->name('admin.entregas.destroy');
